...
hole_0.Radius = 2.5
hole_0.Height = 5.0 + 20
hole_0.Placement.Base = FreeCAD.Vector(50.0/2, 50.0/2, -10)
hole_objects.append(hole_0)

# Cut holes from base
if hole_objects:
    fused_holes = doc.addObject("Part::MultiFuse", "AllHoles")
...
# EXPORT TO STL
import Mesh
output_path = r"C:\portfolio\text to cad\backend\outputs\1767163298.stl"
