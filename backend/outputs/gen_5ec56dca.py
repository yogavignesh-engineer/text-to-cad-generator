...
# Create base plate
plate = Part.makeBox(50.0, 60.0, 10.0)
# Create hole cylinder at center
hole = Part.makeCylinder(7.5, 10.0)
hole.translate(FreeCAD.Vector(25.0, 30.0, 0))
# Cut hole from plate
...
MeshObj.Mesh.write(r"C:\portfolio\text to cad\backend\outputs\gen_5ec56dca.stl")
