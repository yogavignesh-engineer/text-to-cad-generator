...
# Holes (4x 8.0mm diameter)
hole = doc.addObject("Part::Cylinder", "Hole")
hole.Radius = 4.0
hole.Height = 24.0
hole.Placement.Base = FreeCAD.Vector(50.0, 25.0, -10)
...
# Export to STL
import Mesh
output_path = r"C:\Users\_YOGA_VIGNESH_\Videos\text to cad\outputs\output_1766294200.stl"
