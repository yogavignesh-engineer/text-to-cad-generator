...
# Base Gear (simplified as cylinder)
base = doc.addObject("Part::Cylinder", "Base")
base.Radius = 60.0
base.Height = 20.0
print(f"[FREECAD] Created gear: R{base.Radius} H{base.Height} teeth=20")
...
# Export to STL
import Mesh
output_path = r"C:\Users\_YOGA_VIGNESH_\Videos\text to cad\outputs\output_1766322031.stl"
