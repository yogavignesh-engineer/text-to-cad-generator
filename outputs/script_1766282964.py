...
# Holes (1x 8.0mm diameter)
hole = doc.addObject("Part::Cylinder", "Hole")
hole.Radius = 4.0
hole.Height = 50.0
hole.Placement.Base = FreeCAD.Vector(15.0, 15.0, -10)
...
# Export to STL
import Mesh
output_path = r"C:\Users\_YOGA_VIGNESH_\Videos\text to cad\outputs\output_1766282964.stl"
