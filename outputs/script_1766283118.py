...
hole1.Radius = 2.5
hole1.Height = 24.0
hole1.Placement.Base = FreeCAD.Vector(45.0, 5, -10)
holes.append(hole1)
hole2 = doc.addObject("Part::Cylinder", "Hole2")
hole2.Radius = 2.5
hole2.Height = 24.0
hole2.Placement.Base = FreeCAD.Vector(5, 45.0, -10)
holes.append(hole2)
hole3 = doc.addObject("Part::Cylinder", "Hole3")
hole3.Radius = 2.5
hole3.Height = 24.0
hole3.Placement.Base = FreeCAD.Vector(45.0, 45.0, -10)
holes.append(hole3)
...
# Export to STL
import Mesh
output_path = r"C:\Users\_YOGA_VIGNESH_\Videos\text to cad\outputs\output_1766283118.stl"
