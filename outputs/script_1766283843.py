...
# Holes (1x 12.0mm diameter)
hole = doc.addObject("Part::Cylinder", "Hole")
hole.Radius = 6.0
hole.Height = 26.0
hole.Placement.Base = FreeCAD.Vector(40.0, 40.0, -10)
...
# Export to STL
import Mesh
output_path = r"C:\Users\_YOGA_VIGNESH_\Videos\text to cad\outputs\output_1766283843.stl"
