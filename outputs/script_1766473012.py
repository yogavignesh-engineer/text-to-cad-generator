...
try:
    ...
    if len(edges_to_chamfer) > 0:
        ...
        base = chamfer_0
        doc.recompute()
        print(f"[FREECAD] Chamfer applied (size=2.0mm on {len(edges_to_chamfer)} edges)")
    else:
...
# EXPORT TO STL
import Mesh
output_path = r"C:\Users\_YOGA_VIGNESH_\Videos\text to cad\outputs\1766473012.stl"
