...
hole_0.Radius = 3.0
hole_0.Height = 30.0
hole_0.Placement.Base = FreeCAD.Vector(50.0, 50.0, -10)
...
try:
    ...
    thread_obj_0.Placement.Base = FreeCAD.Vector(50.0, 50.0, -5)
...
import Mesh
import os
output_path = r"C:\Users\_YOGA_VIGNESH_\Videos\text to cad\outputs\output_1766392922.stl"
