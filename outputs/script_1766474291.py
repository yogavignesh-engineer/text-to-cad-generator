...
thread_pitch = 1.25
thread_helix_0 = Part.makeHelix(thread_pitch, 10 + 10, 5.0 * 0.9)
thread_profile_0 = Part.Wire(Part.makeCircle(5.0 * 0.12, FreeCAD.Vector(5.0 * 0.9, 0, 0)))
try:
...
# EXPORT TO STL
import Mesh
output_path = r"C:\Users\_YOGA_VIGNESH_\Videos\text to cad\outputs\1766474291.stl"
