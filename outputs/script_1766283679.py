...
hole1.Radius = 6.0
hole1.Height = 24.0
hole1.Placement.Base = FreeCAD.Vector(75.0, 5, -10)
holes.append(hole1)
...
hole3.Radius = 6.0
hole3.Height = 24.0
hole3.Placement.Base = FreeCAD.Vector(75.0, 75.0, -10)
holes.append(hole3)
...
# Export to STL
import Mesh
output_path = r"C:\Users\_YOGA_VIGNESH_\Videos\text to cad\outputs\output_1766283679.stl"
